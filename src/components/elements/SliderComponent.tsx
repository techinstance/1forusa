...
const SliderComponent = ({ goToNextComponent, navigation }: Props) => {
  ...
  useEffect(() => {
    const mockData: ContentItem[] = [
      ...
      {
        data: 'Spending',
        img: 'https://images.unsplash.com/photo-1533055640609-24b498cdfd24',
      },
      {
        data: 'Discipline',
        img: 'https://images.unsplash.com/photo-1610878180933-d4351f6e1d03',
      },
      {
        data: 'Investing',
        img: 'https://images.unsplash.com/photo-1579546929662-711aa81148cf',
      },
      {
        data: 'Growth',
        img: 'https://images.unsplash.com/photo-1549887534-274234f3c48b',
      },
      { data: 'Reflection', img: '' },
    ];
        ...
        <View style={[styles.fullscreenImage, styles.feedbackSlide]}>
          ...
          {userReflection.trim().length > 0 && (
            <>
              ...
              >
                <View
                  style={[styles.checkbox, postPublicly && styles.checkedBox]}
                />
                <Text style={styles.checkboxLabel}>
                  I want to post this reflection
                </Text>
              </Pressable>
